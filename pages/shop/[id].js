import React, {
  ...
  import { COMMISSION_OFFICE, S3_URL, calculateRoundedValue, emptyImage, numberFormat } from "../../helper";
        ...
        <div className="containerSalepage">
          <div className="cardItems">
            {loadingLiveStock || loadingStock ? (
              ...
              <Row xs={width > 320 ? 3 : 2} sm={4} lg={5} style={{padding:'1'}}>
            ...
            <div className="viewProfile p-4">
              ...
              <div
                ...
                <div className="contactImageShop">
                  <Image src={whatsAppIcon} alt="imageContact" />
                </div>
